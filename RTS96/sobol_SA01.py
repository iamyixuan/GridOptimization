...
'''
load_model = pickle.load(open('area1_model.sav', 'rb'))

param_values = saltelli.sample(problem, 40000, calc_second_order=False)
X = param_values
print X.shape
...
pickle.dump(Si, open('SA_resultsArea1.pkl','wb'))
